...
#def vis_image(img, boxes, cls_prob=None, mode=0, font_file='./fonts/ARIAL.TTF'): # clw modify: 这个字体不一定有,改成电脑里有的
def vis_image(img, boxes, cls_prob=None, mode=0, font_file='./Ubuntu-B.ttf'):
