...
os.environ['CUDA_VISIBLE_DEVICES'] = '0'  # clw modify
import cv2
import numpy as np
...
config_file = "../configs/rrpn/e2e_rrpn_R_50_C4_1x_DOTA_test.yaml" # clw modify
...
coco_demo = RRPNDemo(
    ...
    confidence_threshold=0.4,  # clw modify
)
...
testing_dataset = {
    ...
    'DOTA': {
        'testing_image_dir': '/media/clwclw/Elements/deep_learning/competion/2019yaogan/val/images',
        'test_vocal_dir': 'media/clwclw/Elements/deep_learning/competion/2019yaogan/val'
    }
}
...
for image in imlist:
    ...
    voc_path = os.path.join(vocab_dir, 'voc_dota.txt')
